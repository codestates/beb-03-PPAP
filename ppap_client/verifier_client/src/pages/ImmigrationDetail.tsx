            ...
            <div className="text-gray-700">
              ...
              <div className="grid md:grid-cols-2 text-sm">
                <div className="grid grid-cols-2">
                  ...
                  <div className="px-4 py-3 ">{passportDataInfo.user_name}</div>
                </div>
                <div className="grid grid-cols-2">
                ...
                <div className="grid grid-cols-2">
                  ...
                  <div className="px-4 py-3">{passportDataInfo.phone_num}</div>
                </div>
                <div className="grid grid-cols-2">
          ...
          <div className="md:w-12/12 bg-white p-1 shadow-sm rounded-sm">
            ...
            <div className="text-gray-700">
              <div className="grid md:grid-cols-2 text-sm">
                ...
                <div className="grid grid-cols-2">
                  ...
                  <div className="px-4 py-3">{VisaDataInfo.visa_expired_date}</div>
                </div>
                <div className="grid grid-cols-2">
                  <div className="px-4 py-3 font-semibold">Visa Country</div>
                  <div className="px-4 py-3">{VisaDataInfo.country_code}</div>
                </div>
              </div>
            </div>
            ...
            <div className="text-gray-700">
              ...
              <div className="grid md:grid-cols-2 text-sm">
                ...
                <div className="grid grid-cols-2">
                  <div className="px-4 py-3 font-semibold">Gender</div>
                  <div className="px-4 py-3">{VisaDataInfo.sex === "F" ? "FEMALE" : "MALE"}</div>
                </div>
                <div className="grid grid-cols-2">
                ...
                <div className="grid grid-cols-2">
                  ...
                  <div className="px-4 py-3">{VisaDataInfo.creation_date}</div>
                </div>
              </div>
            </div>
          </div>
